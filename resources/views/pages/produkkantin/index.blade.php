...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Produk kantin</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <!--begin::Add product-->
                            <a href="{{ route('produkkantin.create') }}" class="btn btn-primary">
                                Tambah Produkkantin</a>
                            <!--end::Add product-->
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                @if ($item->gambar)
                                                    <!--begin::Thumbnail-->
                                                    <a href="{{ route('produkkantin.edit', $item->id) }}"
                                                ...
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ route('produkkantin.edit', $item->id) }}"
                                                        ...
                                                        data-kt-ecommerce-product-filter="product_name">{{ $item->nama_produk }}</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <!--begin::Category=-->
                                        <!--begin::Qty=-->
                                        <td class="text-end pe-0" data-order="{{ $item->jumlah }}">
                                            <span class="fw-bold ms-3">{{ $item->jumlah }}</span>
                                        </td>
                                        <!--end::Qty=-->
                                        <!--begin::Price=-->
                                        <td class="text-end pe-0">
                                            <span class="fw-bold ms-3">Rp.{{ number_format($item->jumlah) }}</span>
                                        </td>
                                        <!--end::Price=-->
                                        <!--begin::Action=-->
                                        <td class="text-end">
