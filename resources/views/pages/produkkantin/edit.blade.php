        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_ecommerce_edit_category_form" class="form d-flex flex-column flex-lg-row"
                    data-kt-redirect="{{ route('produkkantin.index') }}" action="{{ route('produkkantin.update', $product->id) }}"
                    method="PUT">
                    <!--begin::Aside column-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-placeholder="Select an option"
                                    ...
                                    <option value="Pulsa" {{ $product->category == 'Pulsa' ? 'selected' : '' }}>Pulsa
                                    </option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('produkkantin.index') }}}" id="kt_ecommerce_edit_product_cancel"
